...
import { FadeInOnce } from "@/components/fade-in-once"
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-visible pt-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          {/* Badge */}
          <FadeInOnce direction="down" duration={0.6}>
          ...
          {/* Main Heading */}
          <FadeInOnce direction="up" duration={0.8} delay={0.2}>
          ...
          {/* Subtitle */}
          <FadeInOnce direction="up" duration={0.8} delay={0.4}>
          ...
          {/* CTA Buttons */}
          <FadeInOnce direction="up" duration={0.8} delay={0.6}>
          ...
          {/* Stats */}
          <FadeInOnce direction="up" duration={0.8} delay={0.8}>
